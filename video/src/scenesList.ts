...
export const SCENE_LIST: [string, SceneDef][] = [
  ...
  ['F1-Sken', { component: F1_Sken, seconds: 10, stills: [30, 150, 270] }],
  ['C7-Hierarchia', { component: C7_Hierarchia, seconds: 8.5, stills: [15, 120, 210] }],
  ['C6-Spracovanie', { component: C6_Spracovanie, seconds: 4, stills: [25, 60, 115] }],
  ['F2-Metadata', { component: F2_Metadata, seconds: 8.3, stills: [15, 80, 200] }],
  ['F4-Kontrola', { component: F4_Kontrola, seconds: 12.9, stills: [20, 95, 320] }],
