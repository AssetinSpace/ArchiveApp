...
/**
 * Sprievodne kroky vpravo (Krok i / n, nazov, riadok, body postupu) - rovnaky
 * jazyk v C5 aj pri footage. `frame` = aktualny frame klipu.
 */
export const StepsPanel: React.FC<{ frame: number; steps: Step[]; left?: number; width?: number; top?: number; opacity?: number }> = ({ frame, steps, left = 1380, width = 500, top = 320, opacity = 1 }) => {
