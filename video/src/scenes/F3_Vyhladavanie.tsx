 ...
 * Kolo 35: uvodna veta o praci s databazou (vyhladavanie, zoskupovanie, exporty) nad zmrazenou uvodnou obrazovkou:
 * spot na zalozkach, potom na zalozke Hladat a na poli vyhladavania; zvyraznenia su spoty (ramik + stmavene okolie).
 */
const ID = 'f3-search';
export const F3_SECONDS = cutDuration(ID);
const vo = (i: number, k = 0) => voAt('F3-Vyhladavanie', i, k);
const F3_STEPS: Step[] = [
  { from: 0, title: 'Práca s databázou' },
  { from: vo(0, 2), title: 'Kľúčové slovo' },
...
const F3_MARKS: Mark[] = [
  markAt(ID, 0.9, vo(0, 1) / 1000 - 0.15, 126, 402, 1702, 56, spot), // zalozky: Hladat, Kluce metadat, QR kody, Prilohy, Kontroly, Statistiky, Graf
  markAt(ID, vo(0, 1) / 1000, vo(0, 2) / 1000 - 0.15, 126, 402, 214, 56, spot), // zalozka Hladat
  markAt(ID, vo(0, 2) / 1000, segStart(ID, 1), 190, 578, 1638, 62, spot), // pole vyhladavania (pisanie slova)
