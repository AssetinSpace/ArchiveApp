...
| C2-Hladanie | Hľadanie (kancelária → sklad) | navy | Panáčik príde ku skrini, otvorí ju, „?“, vyletí šanón a rolka, odíde doprava; kamera s ním prejde panom do skladu; klučkuje k strednému regálu, „?“; kamera nájde na policu, sklad vybledne; prvá krabica sa vytiahne z police, otvorí (vidno steny, dno, zložky), zložky sa postupne vyberú a vrátia (bublinka „?“), zavrie, zasunie; to isté druhá; väčší „?“ nad regálom = začiatok C4 | 1,5 s „Dokumentáciu máte. V kancelárii, v sklade… niekde.“ · 8 s „Len ju nikto nevie nájsť.“ | 14,5 s | ☐ ▶ |
...
| `out/mp4/Full_1080p.mp4` | všetkých 9 klipov za sebou, tvrdé strihy, 82 s – kontrola tempa |
