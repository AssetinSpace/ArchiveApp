...
| C2-Hladanie | Hľadanie (kancelária → sklad) | navy | Panáčik príde ku skrini, otvorí ju, vyletí šanón („?“) a rolka („?“), odíde doprava; prestrih: platňa s kanceláriou ide hore a spod nej sa vysunie sklad (suterén); panáčik klučkuje k strednému regálu, „?“; kamera nájde na policu, sklad vybledne; prvá krabica von, veko, všetky zložky naraz hore, bublinka „?“, späť, zasunúť; druhá to isté; väčší „?“ nad regálom = začiatok C4 | 1,5 s „Dokumentáciu máte. V kancelárii, v sklade… niekde.“ · 7,8 s „Len ju nikto nevie nájsť.“ | 12,5 s | ☐ ▶ |
| C4-Cena | 2× → predel | navy → biela | Začína rovnakým regálom ako koniec C2/C3; regál sa odsunie doľava, vedľa neho veľký „?“, hodiny s točiacou sa ručičkou, šípka k výkresu s pečiatkou; veľké cenovky; „2× €€€“. Predel problém → riešenie: všetko okrem regálu vybledne, kamera nájde na krabicu, z nej sa rozleje biele svetlo so zeleným lemom, na bielej sa nakreslí značka Assetin s lockupom, zmizne do pätičky a na podstavci sa usadí krabica z C5 | 5,8 s „Zaplatené dvakrát za tú istú dokumentáciu.“ · 10 s náhovor „Dá sa to inak. Assetin Archives.“ | 11,5 s | ☐ ▶ |
...
| `out/mp4/Full_1080p.mp4` | všetkých 9 klipov za sebou, tvrdé strihy, 82,5 s – kontrola tempa |
