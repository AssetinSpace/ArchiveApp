# Feedback – archív pripomienok z review stránky

## Kolo 4 (20. 9. 2026)

| Klip | Pripomienka (skrátene) | Riešenie |
|---|---|---|
| C1 Intro | Nekresliť logo čiarou; z domčeka vyjde „assetin“, pod tým „Archives“, vráti sa do domčeka, cez domček prejde kamera na prvý frame. | Nový intro: wordmark vychádza spoza domčeka, „Archives“ pod ním, zasunie sa späť, nájazd cez domček do navy. |
| C2 Kancelária | Stolička za stôl; veľa bielej splýva; skriňa sa rozpadá pri otváraní, dvere miznú; vysypané veci sa prekrývajú a nevidno čo sú; otázniky skôr; panáčik, ktorý hľadá a vyhadzuje. | Stolička otočená; tmavšie hrany a odlíšené farby dverí/papierov; jedno krídlo sa otáča okolo pántu; panáčik pred skriňou, veci vyletia oblúkom a dopadnú v rade; otázniky od 2 s. |
| C3 Sklad | Trajektória prekrýva krabice; listovanie 3×6 nedáva zmysel; nájazd na regál, prehľadať jednu krabicu, potom druhú, nič sa nenájde. | Cesta pod objektmi v uličke; nájazd na policu s 2 krabicami; každá sa otvorí, zložky sa postupne vyberú a vrátia, zatvorí sa; „?“ nad regálom. |
| C4 Cena | Regál namiesto paliet; vľavo skladovanie, keď sa nič nenájde → nové vyhotovenie, až vtedy 2×; napojiť na predchádzajúci klip. | Začína rovnakým regálom ako koniec C3, cenovka „skladovanie“, vpravo výkres s cenovkou „nové vyhotovenie“, potom „2×“. |
| C5 Terén | QR málo „čiernej“; krabicu preniesť do C7. | Hustejšie QR (viac modulov, plné finder štvorce); C7 začína tou istou krabicou a kamera sa oddiali do hierarchie. |
| C6 Spracovanie | Možno nebude treba, nechať s otáznikom. | Bez zmeny, označené „(?)“. |
...
| F3 | Nový footage, inak rovnaké problémy. | Zatiaľ: detail zložky sa v zázname otvára sám (klik nie je, bublinka odstránená), kroky podľa hlasu: Kľúčové slovo · Záznam a podrobnosti · QR kód overí obsah. Po nahratí nového záznamu nový zostrih. |
| F4 | Nový prehľadnejší footage, inak rovnaké problémy. | Zatiaľ: kliky premerané (prijať 22,05 s, ceruzka 93,1 s, Prijať úpravu 99,0 s, Odoslať 123,1 s), kroky podľa hlasu: Návrh metadát · Overiť a potvrdiť · Opraviť a odoslať. Po nahratí nového záznamu nový zostrih. |
