# Storyboard – Assetin Archives (kolo 6)
...
| C7-Hierarchia →📹 | Hierarchia + sken | biela | Začína tou istou krabicou ako C5 (KR_01), kamera sa oddiali, vedľa sa objavia dve rovnaké krabice s medzerou a KR_01 sa do nej zaradí; nad ňou vyrastie polica (2 rady krabíc), pod ňou zložky a dokumenty; mobil naskenuje krabicu, vetva sa zvýrazní zelenou čiarou (bez kruhov); strom vybledne, mobil nájde na celý frame → footage | 3 s „Každá položka má svoje miesto.“ | 10 s | ☐ ▶ |
...
- kolo 4, 5 a 6 (pripomienky z review stránky, viď FEEDBACK.md): zapracované; nové MP4 na review stránke.
